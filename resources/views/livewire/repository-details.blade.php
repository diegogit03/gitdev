                    ...
                    @foreach ($objects as $object)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200 flex items-center ">
                                @svg($object['type'] === 'blob' ? 'eos-insert-drive-file' : 'eos-folder', 'w-8')
                                <div>
                                    {{ $object['name'] }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $object['last_commit']['description'] }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $object['last_commit']['date'] }}</td>
                        </tr>
                    @endforeach
